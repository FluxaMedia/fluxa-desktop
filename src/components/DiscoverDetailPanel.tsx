...
const DP: Record<string, React.CSSProperties> = {
  ...
  imdbBadge: { color: 'rgba(255,255,255,0.5)', fontSize: 12, fontWeight: 600, background: 'rgba(255,255,255,0.08)', borderRadius: 4, padding: '2px 7px', border: '1px solid rgba(255,255,255,0.1)' },
  ...
  detailsBtn: { display: 'inline-flex', alignItems: 'center', gap: 5, height: 38, padding: '0 18px', background: '#FFFFFF', color: '#000000', border: 'none', borderRadius: 8, fontSize: 13, fontWeight: 700, cursor: 'pointer', flexShrink: 0 },
};
